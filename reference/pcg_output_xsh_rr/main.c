...
int test_pcg_output_xsh_rr_32_16(void)
{
    FILE *fp;
    ...
    {
        fprintf(fp, "%d %d\n", (int32_t)state, (int16_t)pcg_output_xsh_rr_32_16(state));
    }
...
int test_pcg_output_xsh_rr_64_32(void)
{
    FILE *fp;
    ...
    {
        fprintf(fp, "%ld %d\n", (int64_t)state, (int32_t)pcg_output_xsh_rr_64_32(state));
    }
...
int main(void)
{
    ...
    stat_test = test_pcg_output_xsh_rr_32_16();
    if (stat_test == EXIT_FAILURE) return EXIT_FAILURE;

    stat_test = test_pcg_output_xsh_rr_64_32();
    if (stat_test == EXIT_FAILURE) return EXIT_FAILURE;
