...
int test_pcg_output_rxs_m_16_8(void)
{
    FILE *fp;
    ...
    {
        fprintf(fp, "%d %d\n", (int16_t)state, (int8_t)pcg_output_rxs_m_16_8(state));
...
int test_pcg_output_rxs_m_64_32(void)
{
    FILE *fp;
    ...
    {
        fprintf(fp, "%ld %d\n", (int64_t)state, (int32_t)pcg_output_rxs_m_64_32(state));
    }
...
int main(void)
{
    ...
    stat_test = test_pcg_output_rxs_m_64_32();
    if (stat_test == EXIT_FAILURE) return EXIT_FAILURE;
