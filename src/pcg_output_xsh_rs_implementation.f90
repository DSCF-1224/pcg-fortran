submodule (pcg_fortran) pcg_output_xsh_rs_implementation
    ...
    module procedure pcg_output_xsh_rs_64_32

        integer(int64) :: i
        integer(int64) :: shift

        i      = ieor(shiftr(state, 22), state)
        shift  = shiftr(state, 61) + 22_int32
        xsh_rs = int(shiftr(i, shift), int32)

    end procedure pcg_output_xsh_rs_64_32
    ...
    module procedure test_pcg_output_xsh_rs
        ...
        call test_pcg_output_xsh_rs_64_32
    ...
    subroutine test_pcg_output_xsh_rs_64_32
    ...
    end subroutine test_pcg_output_xsh_rs_64_32
