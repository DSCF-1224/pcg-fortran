program test
    ...
    call test_pcg_step(rng_mcg_8 )
    call test_pcg_step(rng_mcg_16)
    call test_pcg_step(rng_mcg_32)
    call test_pcg_step(rng_mcg_64)

    call test_pcg_step(rng_oneseq_8 )
    call test_pcg_step(rng_oneseq_16)
    call test_pcg_step(rng_oneseq_32)
    call test_pcg_step(rng_oneseq_64)

    call test_pcg_step(rng_setseq_8 )
    call test_pcg_step(rng_setseq_16)
    call test_pcg_step(rng_setseq_32)
    call test_pcg_step(rng_setseq_64)

    call test_pcg_step(rng_unique_8 )
    call test_pcg_step(rng_unique_16)
    call test_pcg_step(rng_unique_32)
    call test_pcg_step(rng_unique_64)
