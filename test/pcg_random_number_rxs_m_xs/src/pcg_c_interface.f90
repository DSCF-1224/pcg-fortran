module pcg_c_interface
    ...
    public  :: pcg_oneseq_64_rxs_m_xs_64_random_r_by_c
    public  :: pcg_setseq_64_rxs_m_xs_64_random_r_by_c
    public  :: pcg_unique_64_rxs_m_xs_64_random_r_by_c
    ...
    interface
        ...
        subroutine pcg_oneseq_64_rxs_m_xs_64_random_r_core(harvest_size, harvest) bind(C, name="signed_pcg_oneseq_64_rxs_m_xs_64_random_r")
        ...
        end subroutine pcg_oneseq_64_rxs_m_xs_64_random_r_core



        subroutine pcg_setseq_64_rxs_m_xs_64_random_r_core(harvest_size, harvest) bind(C, name="signed_pcg_setseq_64_rxs_m_xs_64_random_r")
        ...
        end subroutine pcg_setseq_64_rxs_m_xs_64_random_r_core



        subroutine pcg_unique_64_rxs_m_xs_64_random_r_core(harvest_size, harvest) bind(C, name="signed_pcg_unique_64_rxs_m_xs_64_random_r")
        ...
        end subroutine pcg_unique_64_rxs_m_xs_64_random_r_core
    ...
    subroutine pcg_oneseq_64_rxs_m_xs_64_random_r_by_c(harvest_size, harvest)
        ...
        call pcg_oneseq_64_rxs_m_xs_64_random_r_core( harvest_size, harvest(:) )

    end subroutine pcg_oneseq_64_rxs_m_xs_64_random_r_by_c



    subroutine pcg_setseq_64_rxs_m_xs_64_random_r_by_c(harvest_size, harvest)
        ...
        call pcg_setseq_64_rxs_m_xs_64_random_r_core( harvest_size, harvest(:) )

    end subroutine pcg_setseq_64_rxs_m_xs_64_random_r_by_c



    subroutine pcg_unique_64_rxs_m_xs_64_random_r_by_c(harvest_size, harvest)
        ...
        call pcg_unique_64_rxs_m_xs_64_random_r_core( harvest_size, harvest(:) )

    end subroutine pcg_unique_64_rxs_m_xs_64_random_r_by_c
