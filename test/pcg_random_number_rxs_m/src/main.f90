program test
    ...
    if ( .not. pcg_mcg_16_rxs_m_8_random_r()     )  error stop ' Failed: pcg_mcg_16_rxs_m_8_random_r'
    if ( .not. pcg_oneseq_16_rxs_m_8_random_r()  )  error stop ' Failed: pcg_oneseq_16_rxs_m_8_random_r'
    if ( .not. pcg_setseq_16_rxs_m_8_random_r()  )  error stop ' Failed: pcg_setseq_16_rxs_m_8_random_r'
    if ( .not. pcg_unique_16_rxs_m_8_random_r()  )  error stop ' Failed: pcg_unique_16_rxs_m_8_random_r'
